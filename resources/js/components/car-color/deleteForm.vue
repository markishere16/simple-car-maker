    ...
    <div>
        ...
        <v-card>
            <v-form ref="form"   lazy-validation>
                ...
                <v-card-text>
                    Are you sure you want to delete <b>{{car_color.name}}</b>
                </v-card-text>
                <v-card-actions>
                    <v-spacer></v-spacer>
                    ...
                    <v-btn color="blue darken-1" text  :loading="isloading"
                        :disabled="isloading" @click="deleteColor">
                        Yes
                    </v-btn>
                </v-card-actions>
            </v-form>
...
<script>
    export default {
        ...
        methods: {
            ...
            deleteColor() {
                this.$store.dispatch('deleteCarColor', {vm: this, payload: this.car_color})
                .then(() => {
